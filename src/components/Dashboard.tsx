  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden relative">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-secondary/15 rounded-full blur-[80px] animate-pulse-slow" style={{ animationDelay: '4s' }} />
      </div>
            ...
            <div className="flex items-center gap-2">
              {notificationPermission !== 'granted' && (
                <motion.button
                  ...
                  className="glass px-3 py-2 rounded-xl flex items-center gap-2 text-sm hover:bg-primary/20 transition-colors"
                >
              ...
              <motion.button
                ...
                className="glass p-2 rounded-xl hover:bg-primary/20 transition-colors"
              >
      ...
      <main className="relative z-10 container mx-auto px-4 py-6 pb-24">
        ...
        >
          ...
          <motion.button
            ...
            className="glass-subtle min-h-[200px] rounded-2xl flex flex-col items-center justify-center gap-3 hover:bg-card/60 transition-all group border-dashed border-2 border-border/50 hover:border-primary/50"
          >
